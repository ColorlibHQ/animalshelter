...
function animalshelter_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'animalshelter' ),
        'next_string'     => esc_html__( '&raquo;', 'animalshelter' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'animalshelter_pagination_defaults', $defaults )
    );
