...
class Animalshelter_Enqueue {

	public $scripts = array();

	public function animalshelter_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'animalshelter_frontend_enqueue_scripts', ) );
	}

	public function animalshelter_frontend_enqueue_scripts( ) {
