...
/**
 *
 * Animalshelter elementor few words section widget.
 *
 * @since 1.0
 */
class Animalshelter_sh extends Widget_Base {

	public function get_name() {
		return 'animalshelter-sh';
	}

	public function get_title() {
		return __( 'Section Heading', 'animalshelter-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'animalshelter-companion' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->add_control(
            'sh_sectionsubtitle',
            [
                'label'       => esc_html__( 'Sub Title', 'animalshelter-companion' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'animalshelter-companion' ),
