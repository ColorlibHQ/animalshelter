...
// image default alt
if( ! function_exists( 'animalshelter_img_default_alt' ) ) {
	function animalshelter_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'animalshelter_img_tag' ) ) {
	function animalshelter_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = animalshelter_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'animalshelter_anchor_tag' ) ) {
	function animalshelter_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'animalshelter' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'animalshelter_heading_tag' ) ) {
	function animalshelter_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'animalshelter' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'animalshelter_paragraph_tag' ) ) {
	function animalshelter_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'animalshelter_other_tag' ) ) {
	function animalshelter_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'animalshelter_button_element ' ) ) {
	function animalshelter_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'animalshelter' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
